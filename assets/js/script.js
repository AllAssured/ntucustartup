$(document).ready(function () {
  ...
  $('#entry_1550087588').blur(function () {
    var icNum = document.getElementById('entry_1550087588').value
    icNum = icNum.toUpperCase()
    document.getElementById('entry_1550087588').value = icNum
    console.log(icNum)
    var icArray = []
    ...
    if (icNum.length === 9) {
      ...
      if (checkSum === icArray[8]) {
        ...
        $('#entry_1550087588').removeClass('error')
        $('#entry_1550087588').addClass('valid')
      } else {
        console.log('Invalid NRIC Number')
        $('#entry_1550087588').addClass('error')
        $('#entry_1550087588').removeClass('valid')
      }
    }
  })
  ...
  var autocomplete = new google.maps.places.Autocomplete(
    (document.getElementById('entry_1710960565')),
    {types: ['geocode']}
  )
  ...
  function fillInAddress () {
    ...
    document.getElementById('entry_1710960565').value = address1
    var postalCode = place.address_components[5].long_name
    document.getElementById('entry_1670719225').value = postalCode
  }
})
